  ...
  >
   ...
   V416z"
    ...
    <g>
      <path
        style={{ fill: "#FFFFFF" }}
        d="M103.408,327.84v47.328c0,5.648-4.592,8.832-9.216,8.832c-4.096,0-7.664-3.184-7.664-8.832v-72.016
       ...
       c-4.592,5.648-10.352,5.648-14.576,0L103.408,327.84z"
      />
      <path
        style={{ fill: "#FFFFFF" }}
        d="M196.496,303.152c0-4.224,3.328-8.848,8.704-8.848h29.552c16.64,0,31.616,11.136,31.616,32.496
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M357.728,374.16c-9.088,7.536-20.224,10.752-31.472,10.752c-26.88,0-45.936-15.36-45.936-45.808
       ...
       C360.928,369.552,359.904,371.712,357.728,374.16z"
      />
    </g>
    <path
      style={{ fill: "#CAD1D8" }}
