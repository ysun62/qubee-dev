  ...
  >
   ...
   V416z"
    ...
    <g>
      <path
        style={{ fill: "#FFFFFF" }}
        d="M116.608,384c-4.48,0-7.936-3.456-7.936-7.936v-72.656c0-4.608,3.456-7.936,7.936-7.936h45.92
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M190.48,303.152c0-4.224,3.328-8.848,8.704-8.848h29.552c16.64,0,31.616,11.136,31.616,32.496
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M274.8,314.656c2.944-24.816,40.416-29.28,58.08-15.712c8.704,7.024-0.512,18.16-8.192,12.528
