  ...
  >
   ...
   V416z"
    ...
    <g>
      <path
        style={{ fill: "#FFFFFF" }}
        d="M89.216,384c-4.224,0-8.832-2.32-8.832-7.936v-72.656c0-4.608,4.608-7.936,8.832-7.936h29.296
       c58.48,0,57.184,88.528,1.152,88.528H89.216z M97.28,311.072v57.312h21.232c34.544,0,36.08-57.312,0-57.312H97.28z"
      />
      <path
        style={{ fill: "#FFFFFF" }}
        d="M196.688,327.84v47.328c0,5.648-4.608,8.832-9.2,8.832c-4.096,0-7.68-3.184-7.68-8.832v-72.016
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M363.712,374.16c-9.088,7.536-20.224,10.752-31.472,10.752c-26.88,0-45.936-15.36-45.936-45.808
       ...
       C366.912,369.552,365.888,371.712,363.712,374.16z"
      />
    </g>
    <path
      style={{ fill: "#CAD1D8" }}
