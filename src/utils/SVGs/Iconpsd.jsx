  ...
  >
   ...
   V416z"
    ...
    <g>
      <path
        style={{ fill: "#FFFFFF" }}
        d="M100,303.152c0-4.224,3.328-8.848,8.688-8.848h29.552c16.64,0,31.616,11.136,31.616,32.496
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M184.32,314.656c2.944-24.816,40.416-29.28,58.08-15.712c8.704,7.024-0.512,18.16-8.192,12.528
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M278.24,384c-4.224,0-8.832-2.32-8.832-7.936v-72.656c0-4.608,4.608-7.936,8.832-7.936h29.296
