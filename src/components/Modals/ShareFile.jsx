							...
							>
								<NavItem>
									<Button
										...
										onClick={(e) =>
											this.handleToggleNavs(e, "tabs", 1)
										}
								...
								<NavItem>
									<Button
										...
										onClick={(e) =>
											this.handleToggleNavs(e, "tabs", 2)
										}
										className={classnames(
											"mb-sm-3 mb-md-0",
											{
								...
								<NavItem>
									<Button
										...
										onClick={(e) =>
											this.handleToggleNavs(e, "tabs", 3)
										}
										className={classnames(
											"mb-sm-3 mb-md-0",
											{
								...
								<NavItem>
									<Button
										...
										onClick={(e) =>
											this.handleToggleNavs(e, "tabs", 4)
										}
										className={classnames(
											"mb-sm-3 mb-md-0",
											{
								...
								<NavItem>
									<Button
										...
										onClick={(e) =>
											this.handleToggleNavs(e, "tabs", 5)
										}
										className={classnames(
											"mb-sm-3 mb-md-0",
											{
						...
						<TabContent activeTab={"tabs" + this.state.tabs}>
							<TabPane tabId="tabs1">
								<p className="description">
									This link will allow others to view,
									download, and comment. You can disable this
									link anytime in Shared Items.
								</p>
							</TabPane>
						</TabContent>
					</ModalFooter>
